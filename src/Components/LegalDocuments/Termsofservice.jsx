...
<h1>Terms and Conditions of Fantasy Mmadness</h1>

<p>These Terms govern:</p>
<p>• the use of this Application, and,</p>
<p>• any other related Agreement or legal relationship with the Owner in a legally binding way. Capitalized words are defined in the relevant dedicated section of this document.</p>
...
<p>Fantasy Mmadness League (FMMA) is a digital service and a platform where combat sports fans can test their boxing/MMA knowledge and compete against each other.</p>

<h1>What the User should know at a glance</h1>

<p>• The Service/this Application is only intended for Consumers.</p>
...
<p>• Users must qualify as Consumers;</p>
...
<h1>Account suspension and deletion</h1>
...
<h1>Content on this Application</h1>
...
<h1>Rights regarding content on this Application - All rights reserved</h1>
...
<h1>Content provided by Users</h1>
...
<h1>Rights regarding content provided by Users</h1>
...
<h1>Access to provided content</h1>
...
<h1>Publicly available content</h1>

<p>Content meant for public availability shall be automatically made public on this Application upon upload or, at the sole discretion of the Owner, at a later stage.</p>
<p>Any personal data, identifier or any other information that Users upload in connection with such content (such as a User-ID, avatar or nickname etc.) shall also appear in connection with the published content.</p>
...
<h1>Liability and indemnification</h1>

<p>Unless otherwise explicitly stated or agreed with Users, the Owner’s liability shall be limited as follows:</p>
<p>The Owner shall be liable only for damages directly attributable to the Service's malfunctioning up to an amount equal to the value of the fees paid by the User or up to the corresponding market value of the Service for the relevant period of usage.</p>
<p>The Owner shall not be liable for any damages, losses, or costs due to User’s non-fulfillment of the Agreement or in the case of events attributable to third parties.</p>
<p>Users agree to indemnify and hold the Owner and its subsidiaries, affiliates, officers, directors, agents, co-branders, partners, and employees harmless from and against any claim or demand – including but not limited to legal fees and costs – made by any third party due to or arising out of the User’s culpable or negligent conduct, violation of these Terms, violation of third-party rights, or violation of statutory provisions by the User or its affiliates, officers, directors, agents, co-branders, partners, and employees to the extent allowed by applicable law.</p>

<h1>Common provisions</h1>

<p>No Waiver</p>
<p>The Owner’s failure to assert any right or provision under these Terms shall not constitute a waiver of any such right or provision.</p>
...
<p>Within the limits of law, the Owner may also decide to suspend or terminate the Service altogether.</p>
<p>If the Service is terminated, the Owner will cooperate with Users to enable them to withdraw Personal Data or information in accordance with applicable law.</p>
...
<h1>Assignment of contract</h1>

<p>The Owner reserves the right to transfer, assign, dispose of by novation, or subcontract any or all rights or obligations under these Terms, taking the User’s legitimate interests into account. Provisions regarding changes of these Terms shall apply accordingly.</p>
...
<p>Users from such jurisdictions may access such rights by simply using this Application.</p>
...
<p>This Application (or this Application)</p>
...
<p>Latest update: August 29, 2024</p>
